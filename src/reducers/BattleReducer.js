import {SAVE_BATTLES, ADD_PARAMS, SEARCH_API_INTIATE, DELETE_PARAM, SAVE_LOCATIONS} from '../actions/constants';
...
export const saveLocations = (state, locations) => {
	return {
		...state,
		locations: [...locations],
	};
...
export const battleReducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case SAVE_LOCATIONS:
			return saveLocations(state, action.payload);
		case ADD_PARAMS:
